...
//     p:38      i:0.0     d:0.58
double kp = 40, ki = 0.0, kd = 0.58;                   //需要你修改的参数
//     p:3.5            i:0.1058           d:0.0
double kp_speed = 4, ki_speed = 0.1058, kd_speed = 0.0;            // 需要你修改的参数
//     p:28            i:0          d:0.29
double kp_turn = 28, ki_turn = 0, kd_turn = 0.29;                 //旋转PID设定
//           PID_Original[6] = {38, 0.0, 0.58, 3.5, 0.1058, 0.0};
...
//  Serial.print(balancecar.pulseleft);
//  Serial.print("\t");
//  Serial.print(balancecar.pulseright);
//  
//  Serial.println("");
}
////////////////////脉冲计算///////////////////////
